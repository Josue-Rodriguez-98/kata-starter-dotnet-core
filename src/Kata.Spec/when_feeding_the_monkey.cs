...
namespace Kata.Spec
{
    ...
    public class when_input_is_one_number
    {
        ...
        It should_return_same_number = () => { _result.Should().Be(5); };
    ...
    public class when_input_is_unknown_amount
    {
        Establish _context = () => { _systemUnderTest = new Calculator(); };
    ...
    public class when_input_has_many_negative_number
    {
        Establish _context = () => { _systemUnderTest = new Calculator(); };
    ...
    public class when_input_has_numbers_over_1000
    {
        Establish _context = () => { _systemUnderTest = new Calculator(); };
